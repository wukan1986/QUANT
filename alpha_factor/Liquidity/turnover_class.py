...
#        today = trade_day.iloc[50]
    ...
    #        today = '20110412'
                ...
                ttm_df.to_csv('%s/%s_%s.csv'%(self.factor_path,self.factor_filename, today1),index=None,header=None)
#                return ttm_df
...
#            return ttm_df
            ...
            ttm_df.to_csv('%s/%s_%s.csv'%(self.factor_path,self.factor_filename, self.today),index=None,header=None)
