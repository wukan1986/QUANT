...
backtest <- function(factor_name, INPUTPATH_alpha,INPUTPATH_bmk, INPUTPATH, OUTPUTPATH, LOCAL_RISKMODEL,
                     initialReferenceValue, start_day, end_day,AxiomaDataDir,flag){
  
  INPUTPATH_universe <- 'F:/axioma_data/universe/'
...
config_path = "E:/syc/data/config.yaml" #'D:/Project/优化�?/axioma_need/config.yaml' 
...
for (n in factor_list) {
  factor_name1 = n
  backtest(factor_name1, INPUTPATH_alpha1,INPUTPATH_bmk1, INPUTPATH1, OUTPUTPATH1,LOCAL_RISKMODEL1,
           initialReferenceValue1, start_day1, end_day1, AxiomaDataDir1, flag)
