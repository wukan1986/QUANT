...
class stdfcff(object):
    ...
    def updatestd(self, ii, factor_num, new_dirpath, new_factor_name, new_factor_path2, new_factor_name2):
        ...
        if new_factor_name2 == 'stdni0':
            ...
            df_regress.columns = ['S_INFO_WINDCODE','NISR2_raw']
            df_regress.to_csv('%s/NISR2/NISR2_raw_CN_%s.csv'%(self.new_dirpath, ii), index=None)
    ...
    def get_stdfcf0(self, new_factor_name2, factor_num):
        ...
        if not os.path.exists(self.new_dirpath + '/' + 'NISR2'):
            os.mkdir(self.new_dirpath + '/' + 'NISR2')
...
if __name__ == '__main__':
    ...
    today = '20171204'
    raw_dirpath = 'F:/factor_data/test_temp2'
