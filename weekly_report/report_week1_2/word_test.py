...
#)
p4 = document.add_paragraph(u'风格因子累计收益率 最近一周', style='ListNumber')
p4.style.font.size = Pt(10)

document.add_picture('data/factor_month.png', width=Inches(6))

document.add_paragraph(u'风格因子累计收益率 最近两周', style='ListNumber')
document.add_picture('data/factor_year.png', width=Inches(6))

document.add_paragraph(' ')

document.add_paragraph(u'申万行业因子累计收益率 最近一周', style='ListNumber')
document.add_picture('data/industry_month.png', width=Inches(6))

document.add_paragraph(' ')

document.add_paragraph(u'申万行业因子累计收益率 最近两周', style='ListNumber')
...
document.save('week_%s.docx'%today)