...
sys.path.append("E:/QUANT/factor_daily/fcff/")
...
raw_dirpath = 'E:/QUANT/factor_daily/fcff/raw_data'

new_dirpath = 'E:/QUANT/factor_daily/fcff/data'  # 处理好的因子存放位置
...
for fre_shift in fre_shift_list:
    net_income = factor_fundmental1.factorGet(sql, cal_mode1, flag, factor_filename1, raw_dirpath, fre_shift,
                                              date=today, fre='day')
...
fre_shift_list = range(6)
for fre_shift in fre_shift_list:
    tot_asset = factor_fundmental.factorGet(sql, cal_mode2, flag, factor_filename2, raw_dirpath, fre_shift, date=today,
                                            fre='day')
